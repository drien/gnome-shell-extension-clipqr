// Dictionary body produced by:
// wget -qO- http://svn.apache.org/repos/asf/httpd/httpd/trunk/docs/conf/mime.types | egrep -v ^# | awk '{ for (i=2; i<=NF; i++) {print "\'"$1"\': \'"$i"\',"}}' | sort
...
export default MIME_EXTENSIONS;